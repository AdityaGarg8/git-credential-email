...
"""
PM_APP_VERSION_ACCOUNT = 'web-account@5.0.325.0'
...
PM_APP_VERSION_MAIL = 'web-mail@5.0.94.9'
...
class ProtonMail:
	...
	def revoke_current_session(self) -> dict:
		"""Revoke the current session."""
		return self._delete('account', 'core/v4/auth').json()
